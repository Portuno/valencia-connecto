  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Previous Events</h1>
        
        <Card className="max-w-3xl mx-auto bg-white shadow-lg hover:shadow-xl transition-shadow mb-8">
          <CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 list-disc list-inside text-gray-600">
                <li>Connected with Valencia's Web3 and real estate communities</li>
                <li>Insightful presentations on RWA basics and real estate tokenization</li>
                <li>Networking with professionals and startups</li>
              </ul>
            </div>
          </CardContent>
        </Card>
